 ...
 *
 * Энэ ажил контейнер эхлэх үед `docker-entrypoint.sh`-аас арын
 * дэвсгэрт ажилладаг. Контейнер deploy болон гэмтлийн дараа дахин
 * эхэлдэг тул каталог бүрэн байвал юу ч хийхгүй — эс бөгөөс seed нь
 * өгөгдлийг арчих байсан. Харин импорт дундаа таслагдаж дутуу үлдсэн
 * бол дараагийн эхлэлд түүнийг дуусгана.
 *
...
async function main(): Promise<void> {
  ...
  // дахин боловсруулах хэрэгтэй болдог. Үүлэн орчинд shell байхгүй тул
