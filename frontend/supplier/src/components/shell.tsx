...
const NAV = [
  ...
  { href: "/products", label: "Бараа ба үнэ", Icon: BoxIcon },
  { href: "/inventory", label: "Үлдэгдэл", Icon: LayersIcon },
  { href: "/warehouses", label: "Агуулах", Icon: WarehouseIcon },
  { href: "/orders", label: "Захиалга", Icon: FileIcon },
  { href: "/deliveries", label: "Хүргэлт", Icon: TruckIcon },
  { href: "/commissions", label: "Шимтгэл, тооцоо", Icon: WalletIcon },
];
...
/** Нэвтрэх хуудас: нийлүүлэгч болон админ эрхээр орно */
function LoginView() {
        ...
        <form onSubmit={submit} className="space-y-3">
          <Field label="И-мэйл">
            <Input
              ...
              placeholder="supplier@barilgahub.mn"
