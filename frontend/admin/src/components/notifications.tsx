  ...
  return (
    <div ref={containerRef} className="relative">
      <button
        ...
        className="relative flex h-9 w-9 items-center justify-center rounded-md border border-ink-600 bg-ink-900 text-mute transition-colors hover:border-mute-dim hover:text-fg"
      >
